			...
			<div class="container" id="exp">
				...
				<div class="row">
					...
					while($r = $queryO->fetch()){
						echo "<div class='userExp'><span class='user_name'>",$r["Name"] ,":</span><br><hr><p class='user_text well'>",$r["Comments"],"</p></div>";
					}
					?>
					</div>
